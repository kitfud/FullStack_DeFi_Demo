...
def test_set_price_feed_contract():
    ...
    # act phase
    prince_feed_address = get_contract("eth_usd_price_feed")
    token_farm.setPriceFeedContract(
        dapp_token.address, prince_feed_address, {"from": account}
    )
    # assert stage
    ...
    with pytest.raises(exceptions.VirtualMachineError):
        token_farm.setPriceFeedContract(
            dapp_token.address, prince_feed_address, {"from": non_owner}
        )
